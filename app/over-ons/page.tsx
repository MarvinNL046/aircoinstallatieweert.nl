...
const features = [
  {
    ...
    description: 'Meer dan 10 jaar ervaring in airconditioning installatie in Weert en omgeving.'
  },
  {
    icon: Award,
  ...
  },
  {
    ...
    description: 'Specialistische kennis van lokale regelgeving en woningen in Weert en omgeving.'
  },
  {
    icon: ThumbsUp,
...
const additionalFeatures = [
  {
    ...
    description: 'Binnen 24 uur reactie op serviceverzoeken in de regio Weert.'
  },
  {
    icon: ShieldCheck,
...
const testimonials = [
  ...
  {
    name: "Kantoorpand Weert",
    location: "Bedrijventerrein, Weert",
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <section className="mb-16">
        <h1 className="text-4xl font-bold mb-6">Over StayCool Airco Weert</h1>
        <div className="prose max-w-none">
          <p className="text-xl mb-6 text-muted-foreground">
            Uw lokale specialist voor airconditioning in Weert en omgeving.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              <p className="mb-4">
                StayCool Airco is uw betrouwbare partner voor alle airconditioning oplossingen in Weert en omgeving. 
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
                  <span>Ervaring met verschillende woningtypen in Weert</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-bold mb-8">Onze Diensten in Weert</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
            <h3 className="text-xl font-semibold mb-4 text-blue-600">Airco Installatie</h3>
            <p className="mb-4">
              Professionele installatie van airconditioning systemen, perfect afgestemd op uw woning of bedrijf in Weert. 
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
            ...
            <p className="mb-4">
              Regelmatig onderhoud en snelle service voor alle merken airconditioners in Weert. 
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
            ...
            <p className="mb-4">
              Persoonlijk advies over de beste airconditioning oplossing voor uw situatie in Weert. 
      ...
      <section className="bg-blue-50 p-8 rounded-lg mb-16">
        ...
        <p className="text-lg mb-4">
          Wij streven ernaar om hoogwaardige klimaatoplossingen toegankelijk te maken voor iedereen in Weert en omgeving. 
        ...
        <p className="text-lg">
          ...
          welzijn van onze gemeenschap en het behoud van het unieke karakter van Weert.
        </p>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="mb-6">
                ...
                Onze experts in Weert staan voor u klaar.
              </p>
            ...
            <div className="hidden md:block">
              <div className="rounded-lg overflow-hidden h-64">
                <iframe 
                  ...
                  title="StayCool Airco Weert Bedrijfsvideo" 
                  frameBorder="0" 
